...
from tayangan.views import show_tayangan, search_results, show_film_details, show_series_details, \
    show_episode_details, show_daftar_kontributor, submit_review_film, submit_review_series
...
urlpatterns = [
    ...
    path('episode_details/<uuid:id_series>/', show_episode_details, name='show_episode_details'),
